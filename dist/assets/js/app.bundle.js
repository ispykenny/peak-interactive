...
/***/ (function(module, exports, __webpack_require__) {
	...
	var $s = {
		...
		$lazyBg: (0, _jquery2.default)('.lazy-bg'),
		$lazyImg: (0, _jquery2.default)('.lazy-img'),
		didScroll: false,
		navShowing: false
	};
	...
	var _lazyload = __webpack_require__(8);
	...
	var lazyBg = function lazyBg() {
		_selectors2.default.$lazyBg.each(function (index, element) {
			var newImg = new Image();
			newImg.src = (0, _jquery2.default)(element).attr('data-bg');
			(0, _jquery2.default)(newImg).on('load', function () {
	...
	var lazyImg = function lazyImg() {
		_selectors2.default.$lazyImg.each(function (index, element) {
			var $this = (0, _jquery2.default)(element);
			var src = $this.attr('data-src');
			var mkImg = new Image();
			mkImg.src = src;
	
			(0, _jquery2.default)(mkImg).on('load', function () {
				$this.attr('src', src);
			});
		});
	};
